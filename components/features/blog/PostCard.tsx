...
export function PostCard({ post }: Props) {
  return (
    <Card className='group bg-card/50 border-border/40 hover:border-primary/20 cursor-pointer overflow-hidden border backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-lg'>
      {post.coverImage && (
